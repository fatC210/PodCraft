  ...
  return (
    <div className="p-8 max-w-3xl mx-auto">
      <div className="mb-10 animate-fade-up">
        <p className="font-mono text-xs text-muted-foreground tracking-widest uppercase mb-2">设置</p>
      ...
      <section className="mb-10 animate-fade-up" style={{ animationDelay: "80ms" }}>
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-sm font-semibold uppercase tracking-wider">AI 模型供应商</h2>
          <button
          ...
          {providers.map(provider => (
            <div key={provider.id} className="bg-card border border-border rounded p-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  <span className="font-mono text-[10px] text-muted-foreground w-16">API 地址</span>
                  <span className="font-mono text-xs text-foreground/80">{provider.baseUrl}</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="font-mono text-[10px] text-muted-foreground w-16">API Key</span>
                  <span className="font-mono text-xs text-foreground/80">{provider.apiKey}</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="font-mono text-[10px] text-muted-foreground w-16">模型</span>
      ...
      <section className="animate-fade-up" style={{ animationDelay: "160ms" }}>
        <h2 className="text-sm font-semibold uppercase tracking-wider mb-4">服务配置</h2>
          ...
          <div className="bg-card border border-border rounded p-4">
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
                ...
                <span className="font-mono text-[10px] text-muted-foreground">网页抓取</span>
              </div>
